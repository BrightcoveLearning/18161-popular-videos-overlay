...
# 18161-popular-videos-overlay
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-popular-videos-overlay.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>popular-videos-overlay.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>popular-videos-overlay.css</strong>.</td>
    </tr>
  </tbody>
</table>
